...
class ModulesController extends Controller
{
    ...
    public function __construct()
    {
        ...
        { 
            ...
            // dd($data);
            return view('superadmin.modules',$data);
        }

        public function createModule()
        { 
            $data['title']       =   'Create Modules';
            $data['menu']        =   'create-modules';
            $data['active_modules']     =   Modules::getModules();
            // dd($data);
            return view('superadmin.add-modules',$data);
        }

        public function editModule($module_id)
        { 
            $data['title']       =   'Edit Modules';
            $data['menu']        =   'edit-modules';
            $data['active_modules']     =   Modules::getModules();
            $data['module_details']     =   Modules::getModuleDetails($module_id);
            
            return view('superadmin.edit-modules',$data);
        }
