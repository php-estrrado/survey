					...
					<table class="table table-bordered text-nowrap" id="example2">
						...
						<tbody>
							...
							<tr>
								...
								<td>12/11/2022</td>
								<td>John</td>
								<td><a href="{{ url('/accountant/receipt-received')}}" style="color:#2b8fca; font-weight:bold;">ADF1234</a></td>
								<!-- <td>Kollam</td> -->
								<td>xyz@gmail.com</td>
								<td>Hydrographic Chart</td>
								<td>Invoice receipt received</td>
							</tr>
							<tr>
								<td>2</td>
								<td>12/11/2022</td>
								...
								<td>xyz@gmail.com</td>
								<td>Hydrographic Chart</td>
								<td>Invoice receipt verified</td>
							</tr>
							<tr>
								<td>3</td>
								<td>12/11/2022</td>
