		...
		<div class="wideget-user-tab">
			<div class="tab-menu-heading p-0">
				<div class="tabs-menu1 px-3">
					<ul class="nav">
						<li><a href="#tab-5" class="active fs-14" data-toggle="tab">Basic</a></li>
						<li><a href="#tab-6" data-toggle="tab" class="fs-14">Invoice</a></li>
						<li><a href="#tab-7" class="fs-14" data-toggle="tab">Report</a></li>
						...
						<div class="card-body">
							<div class="row">
								<div class="col-sm-12 col-md-12">
									<div class="verif-red">Rejected</div>
									<div class="form-group">
										<ul id="lightgallery" class="list-unstyled row">
											<li class="col-xs-6 col-sm-4 col-md-3" data-responsive="{{URL::asset('admin/assets/images/file_image.png')}}" data-src="{{URL::asset('admin/assets/images/file_image.png')}}">
												<a href="{{URL($survey_request_data->receipt_image)}}" target="_blank">
