		...
		<div class="border-0">
			<div class="tab-content">
                ...
                <div class="card newser">
					...
					<div class="card newser">
						<div class="card-body">
							<form action="{{url('admin/reschedule_field_surveyor')}}" method="POST" id="assign_surveyor">
								@csrf
								...
								<div class="btn-list d-flex justify-content-end">
									<button class="btn btn-info" type="submit" value="submit">Approve</button>
									<a href="#" class="modal-effect btn btn-danger" data-effect="effect-scale" data-target="#modaldemo2" data-toggle="modal" href="">Reject</a>
								</div>
							</form>
						</div>
...
<div class="modal" id="modaldemo2">
	<div class="modal-dialog" role="document">
		<div class="modal-content modal-content-demo">
            <form action="{{url('/admin/reject_fieldstudy_reschedule')}}" method="post">
				@csrf
