                                                            ...
                                                            @if($survey_data->role == 1)
                                                                @if($survey_data->survey_status == 27)
                                                                    @if($request_status == 27)
                                                                        <h3 class="timelineleft-header"><a href="{{url('/customer/survey_report')}}/{{$survey_data->survey_request_id}}/{{$survey_data->survey_status}}" target="_blank">{{$survey_data->status_name}} - {{$survey_data->designation}} - {{$survey_data->fullname}}</a></h3>
                                                                    @else
                                                                ...
                                                                @elseif($survey_data->survey_status == 70)
                                                                    @if($request_status == 70)
                                                                        <h3 class="timelineleft-header"><a href="{{url('/customer/receipt_rejected')}}/{{$survey_data->survey_request_id}}/{{$survey_data->survey_status}}">{{$survey_data->status_name}} - {{$survey_data->designation}} - {{$survey_data->fullname}}</a></h3>
                                                                    @else
                                                                        <h3 class="timelineleft-header">{{$survey_data->status_name}} - {{$survey_data->designation}} - {{$survey_data->fullname}}</h3>
                                                                    @endif 
                                                                @elseif($survey_data->survey_status == 51)
                                                                    @if($request_status == 51)
                                                                        <h3 class="timelineleft-header"><a href="{{url('/customer/request_service_invoice')}}/{{$survey_data->survey_request_id}}/{{$survey_data->survey_status}}">{{$survey_data->status_name}} - {{$survey_data->designation}} - {{$survey_data->fullname}}</a></h3>
                                                                    @else
                                                                        <h3 class="timelineleft-header">{{$survey_data->status_name}} - {{$survey_data->designation}} - {{$survey_data->fullname}}</h3>
                                                                    @endif
                                                                @elseif($survey_data->survey_status == 15)
                                                                    @if($request_status == 15)
                                                                        <h3 class="timelineleft-header"><a href="{{url('/customer/request_service_performa_invoice')}}/{{$survey_data->survey_request_id}}/{{$survey_data->survey_status}}">{{$survey_data->status_name}} - {{$survey_data->designation}} - {{$survey_data->fullname}}</a></h3>
                                                                    @else
                                                                        <h3 class="timelineleft-header">{{$survey_data->status_name}} - {{$survey_data->designation}} - {{$survey_data->fullname}}</h3>
                                                                    @endif
                                                                @else
