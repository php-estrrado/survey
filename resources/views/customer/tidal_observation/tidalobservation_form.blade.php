                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <div>
                                        ...
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" onclick="displayDesc(0);" name="benchmark_chart_datum" id="benchmark_chart_datum3" value="na" {{ old('benchmark_chart_datum') == "na" ? 'checked' : '' }}>
