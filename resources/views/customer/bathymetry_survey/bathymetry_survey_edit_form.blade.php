                              ...
                              <div class="tab-pane active" role="tabpanel" id="step1">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-sm-6">
                                    ...
                                    <input class="form-control" type="text" placeholder="Others" name="others" id="others" value="{{ $survey_data->fname }}">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input class="form-control" type="text" name="service_to_be_conducted" id="service_to_be_conducted" placeholder="When Service to be conducted" value="{{ date('d-m-Y',strtotime($survey_data->service_to_be_conducted)) }}">
                                    </div>
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      <label class="form-label-title mt-3" for="filenames">Upload existing drawings/map showing the locations of file upload (jpg, jpeg, jiff, png, pdf) <span class="text-red" style="color: #ff0000;">(Maximum size: 25mb)</span> span</label>
