                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Period of observation Start Date" name="observation_start_date" id="observation_start_date">
                                    </div>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Period of observation End Date" name="observation_end_date" id="observation_end_date">
                                    </div>
