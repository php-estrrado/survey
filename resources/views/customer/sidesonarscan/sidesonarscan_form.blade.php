                    ...
                    <div class="row d-flex justify-content-center">
                      <div class="col-md-12">
                        <div class="wizard">
                          ...
                          <form action="{{url('/customer/sidescanningsonar_survey/save')}}" method="post" id="sidescanningsonar_survey" class="theme-form">
                            @csrf
                            <div class="tab-content" id="main_form">
                              ...
                              <div class="tab-pane" role="tabpanel" id="step4">
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label-title mt-3" for="area_to_scan">Area to be scanned (in sq km)</label>
                                        <input class="form-control" type="number" placeholder="Area to be scanned (in sq km)" name="area_to_scan" id="area_to_scan">
                                    </div>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label-title mt-3" for="depth_of_area">Depth of the area (in meter)</label>
                                        <input class="form-control" type="number" placeholder="Depth of the area (in meter)" name="depth_of_area" id="depth_of_area">
                                    </div>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label-title mt-3" for="interval">Line / scanning interval (in meter)</label>
                                        <input class="form-control" type="number" placeholder="Line / scanning interval" name="interval" id="interval">
                                    </div>
...
@section('js')
  ...
  <script type="text/javascript">
    $("#sidescanningsonar_survey").validate({
      rules: {
        fname: {
          required: true,
        },
