                    ...
                    <div class="row d-flex justify-content-center">
                      <div class="col-md-12">
                        <div class="wizard">
                          ...
                          <form action="{{url('/customer/topographic_survey/save')}}" method="post" id="topographic_survey" class="theme-form">
                            @csrf
                            ...
                            <div class="tab-content" id="main_form">
                              ...
                              <div class="tab-pane" role="tabpanel" id="step4">
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label-title mt-3" for="area_to_survey">Area to be scanned (in sq km) <span class="text-red">*</span></label>
                                        <input class="form-control" type="number" placeholder="Area to be scanned (in sq km)" name="area_to_survey" id="area_to_survey" value="{{ old('area_to_survey') }}">
                                    </div>
                                    <div id="area_to_survey_error"></div>
                                    @error('area_to_survey')
                                      <p style="color: red">{{ $message }}</p>
                                    @enderror
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" placeholder="Scale of survey (in meter)" name="scale_of_survey" id="scale_of_survey" value="{{ old('scale_of_survey') }}">
                                    </div>
  ...
  <script type="text/javascript">
    $("#topographic_survey").validate({
      ...
      errorPlacement: function (error, element) 
      {
        ...
        else if (element.attr("name") == "area_to_survey")
        {
          error.appendTo("#area_to_survey_error");
        }
