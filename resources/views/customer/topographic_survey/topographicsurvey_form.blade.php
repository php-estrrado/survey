                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" placeholder="Area to be scanned (in sq km)" name="area_to_survey" id="area_to_survey">
                                    </div>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" placeholder="Scale of survey (in meter)" name="scale_of_survey" id="scale_of_survey">
                                    </div>
