                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input class="form-control" type="text" placeholder="Year of survey chart required" name="year_of_survey_chart" id="year_of_survey_chart" readonly>
                                    </div>
                                  ...
                                  <div class="col-sm-6">
                                    ...
                                    <input class="form-control" type="number" placeholder="No. of copies required" name="copies_required" id="copies_required">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div>
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="copy_type" id="copy_type" value="print">
                                          <label class="form-check-label" for="copy_type">Print</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="copy_type" id="copy_type" value="soft">
                                          <label class="form-check-label" for="copy_type">Soft Copy</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="copy_type" id="copy_type" value="both">
                                          <label class="form-check-label" for="copy_type">Both</label>
                                        </div>
                                      </div>
                                    </div>
