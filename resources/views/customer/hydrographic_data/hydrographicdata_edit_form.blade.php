                                ...
                                <div class="row">
                                  <div class="col-sm-6">
                                    ...
                                    <select id="menu-type" class="js-example-basic-single col-sm-12" name="type_of_waterbody" id="type_of_waterbody">
                                      ...
                                      <option value="inland_water_bodies" {{ $survey_data->type_of_waterbody == 'inland_water_bodies' ? 'selected' : '' }}>Inland water bodies</option>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label class="form-label-title mt-3" for="year_of_survey_chart">Year of survey chart required <span class="text-red">*</span></label>
                                      <input class="form-control" type="text" placeholder="Year of survey chart required" name="year_of_survey_chart" id="year_of_survey_chart" readonly value="{{ $survey_data->year_of_survey_chart }}">
                                    </div>
                                    <div id="year_of_survey_chart_error"></div>
                                    @error('year_of_survey_chart')
                                      <p style="color: red">{{ $message }}</p>
                                    @enderror
                                  </div>
                                  <div class="col-sm-6">
                                    <label class="form-label-title mt-3" for="copies_required">No. of copies required <span class="text-red">*</span></label>
                                    <input class="form-control" type="number" placeholder="No. of copies required" name="copies_required" id="copies_required" value="{{ $survey_data->copies_required }}">
                                    <div id="copies_required_error"></div>
                                    @error('copies_required')
                                      <p style="color: red">{{ $message }}</p>
                                    @enderror
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label class="form-label-title mt-3" for="copy_type">Whether print/soft copy required or both <span class="text-red">*</span></label>
                                      <div>
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="copy_type" id="copy_type1" value="print" {{ $survey_data->copy_type == "print" ? 'checked' : '' }}>
                                          <label class="form-check-label" for="copy_type1">Print</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="copy_type" id="copy_type2" value="soft" {{ $survey_data->copy_type == "soft" ? 'checked' : '' }}>
                                          <label class="form-check-label" for="copy_type2">Soft Copy</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="copy_type" id="copy_type3" value="both" {{ $survey_data->copy_type == "both" ? 'checked' : '' }}>
                                          <label class="form-check-label" for="copy_type3">Both</label>
                                        </div>
                                      </div>
                                    </div>
                                    <div id="copy_type_error"></div>
                                    @error('copy_type')
                                      <p style="color: red">{{ $message }}</p>
                                    @enderror
                                  </div>
...
@section('js')
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      $('#year_of_survey_chart').datepicker({
        autoclose: true,
        format: " yyyy",
        viewMode: "years", 
        minViewMode: "years",
