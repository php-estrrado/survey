                              ...
                              <div class="tab-pane" role="tabpanel" id="step2">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-sm-6">
                                    ...
                                    <input class="form-control" type="text" placeholder="Name of waterbody" name="place" id="place" value="{{ $survey_data->place }}">
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input class="form-control" type="number" placeholder="No. of locations from which samples to be collected" name="number_of_locations" id="number_of_locations" value="{{ $survey_data->number_of_locations }}">
                                    </div>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input class="form-control" type="number" placeholder="Quantity of sample to be collected in each location(enter value in grams)" name="quantity_of_samples" id="quantity_of_samples" value="{{ $survey_data->quantity_of_samples }}">
                                    </div>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input class="form-control" type="text" placeholder="Interval (in kms)" name="interval_bottom_sample" id="interval_bottom_sample" value="{{ $survey_data->interval_bottom_sample }}">
                                    </div>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <option value="0.4" {{ $survey_data->quantity_bottom_sample == '0.4' ? 'selected' : '' }}>0.4</option>
                                      <option value="0.5" {{ $survey_data->quantity_bottom_sample == '0.5' ? 'selected' : '' }}>0.5</option>
                                      <option value="1" {{ $survey_data->quantity_bottom_sample == '1' ? 'selected' : '' }}>1</option>
                                      <option value="2" {{ $survey_data->quantity_bottom_sample == '2' ? 'selected' : '' }}>2</option>
                                      <option value="5" {{ $survey_data->quantity_bottom_sample == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <option value="bucket" {{ $survey_data->method_of_sampling == 'bucket' ? 'selected' : '' }}>Bucket</option>
                                      <option value="boring" {{ $survey_data->method_of_sampling == 'boring' ? 'selected' : '' }}>Boring</option>
                                  ...
                                  <div class="col-md-6 ">
                                    <div class="form-group">
                                      ...
                                      <textarea class="form-control" type="text" placeholder="Description of Requirement" name="description_of_requirement" id="description_of_requirement">{{ $survey_data->description_of_requirement }}</textarea>
                                    </div>
