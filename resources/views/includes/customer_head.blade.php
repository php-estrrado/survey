...
<style type="text/css">
    .SumoSelect  li.opt.selected span i {
...
<!-- Themify icon-->
<link rel="stylesheet" type="text/css" href="{{URL::asset('public/assets/css/themify.css')}}">
<!-- ratio start -->
<link rel="stylesheet" type="text/css" href="{{URL::asset('public/assets/css/ratio.css')}}">

<!-- Feather icon-->
<link rel="stylesheet" type="text/css" href="{{URL::asset('public/assets/css/feather-icon.css')}}">
<!-- Plugins css start-->
<link rel="stylesheet" type="text/css" href="{{URL::asset('public/assets/css/scrollbar.css')}}">
<link rel="stylesheet" type="text/css" href="{{URL::asset('public/assets/css/animate.css')}}">
<!-- Plugins css Ends-->
<!-- datepicker -->
<!-- <link rel="stylesheet" type="text/css" href="{{URL::asset('public/assets/css/date-picker.css')}}"> -->
<!-- Bootstrap css-->
...
<link rel="stylesheet" type="text/css" href="{{URL::asset('public/assets/css/slick-theme.css')}}">
<!-- App css-->
