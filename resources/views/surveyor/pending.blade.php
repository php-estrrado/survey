...
<div class="page-header">
	<div class="page-leftheader">
		<h4 class="page-title mb-0">File Upload</h4>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{ url('/surveyor/services&requests')}}"><i class="fe fe-layout mr-2 fs-14"></i>Services And Requests</a></li>
			<li class="breadcrumb-item active" aria-current="page"><a href="#">File Upload</a></li>
		</ol>
	</div>
</div>
<!--End Page header-->
	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-auto">
			<div class="text-lg-right btn-list mt-4 mt-lg-0">
				<a href="#" class="modal-effect btn btn-primary" data-effect="effect-scale" data-target="#modaldemo1" data-toggle="modal" href="">Submit</a>
