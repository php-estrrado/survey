...
<div class="row">
	<div class="col-12">
		...
		<div class="card">
			...
			<div class="card-body">
                <form action="{{URL('/draftsman/save_invoice')}}" method="POST">
                    @csrf
                    <input type="hidden" value="{{$survey_id}}" name="id" id="id">
                    <input type="hidden" value="{{$survey_invoice->id}}" name="invoice_id" id="invoice_id">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="bill_invoice_no" id="bill_invoice_no" value="{{$survey_invoice->id}}" readonly>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="invoice_date" id="invoice_date" placeholder="Date" value="{{date('d-m-Y',strtotime($survey_invoice->invoice_date))}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="name_of_work" id="name_of_work" placeholder="Name of Work" value="{{$survey_invoice->name_of_work}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="work_orderno_date" id="work_orderno_date" placeholder="Work order No & Date" value="{{$survey_invoice->work_orderno_date}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="service_code" id="service_code" placeholder="Service Code (SAC)" value="{{$survey_invoice->service_code}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="service_description" id="service_description" placeholder="Description of Service" value="{{$survey_invoice->service_description}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="organization_name" id="organization_name" placeholder="Name of Organisation" value="{{$survey_invoice->organization_name}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="payment_mode" id="payment_mode" placeholder="Mode of Payment" value="{{$survey_invoice->payment_mode}}">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="receiver_name" id="receiver_name" placeholder="Name" value="{{$survey_invoice->receiver_name}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="receiver_address" id="receiver_address" placeholder="Address" value="{{$survey_invoice->receiver_address}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="state_code" id="state_code" placeholder="State Code" value="{{$survey_invoice->state_code}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="gstin_unique_id" id="gstin_unique_id" placeholder="GSTIN/Unique ID" value="{{$survey_invoice->gstin_unique_id}}">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="number" name="survey_charges" id="survey_charges" placeholder="Taxable Bill value" oninput="calculateTaxAmount()" value="{{$survey_invoice->survey_charges}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input class="form-control bg-white" type="text" name="cgst_amount" id="cgst_amount" value="{{$survey_invoice->cgst_amount}}" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input class="form-control bg-white" type="text" name="sgst_amount" id="sgst_amount" value="{{$survey_invoice->sgst_amount}}" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control bg-white" type="text" name="total_tax_amount" id="total_tax_amount" value="{{$survey_invoice->total_tax_amount}}" readonly>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control bg-white" type="text" name="total_tax_amount_words" id="total_tax_amount_words" value="{{$survey_invoice->total_tax_amount_words}}" readonly>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control bg-white" type="text" name="total_invoice_amount" id="total_invoice_amount" value="{{$survey_invoice->total_invoice_amount}}" readonly>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control bg-white" type="text" name="total_invoice_amount_words" id="total_invoice_amount_words" value="{{$survey_invoice->total_invoice_amount_words}}" readonly>
