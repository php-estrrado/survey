				...
				<div class="widget-user-image1 d-sm-flex">
					<div class="mt-1">
						...
						<ul class="mb-0 pro-details">
							...
							<li><span class="h6 mt-3">Type of firm: {{$request_data->firm}}</span></li>
...
<div class="row">
	<div class="col-12">
		<div class="btn-list d-flex justify-content-end">
			<a href="{{URL('/draftsman/download_report')}}/{{$survey_id}}" class="btn btn-primary" >Download Report</a>
		</div>
	</div>
</div>
...
<div class="row">
    <div class="card newser">
        <div class="card-body">
            <div class="card-title font-weight-bold">Upload Final Report:</div>
            <form action="{{URL('/draftsman/upload_final_report')}}" method="post" enctype="multipart/form-data">
				@csrf
