		...
		<div class="card">
			...
			<div class="card-body">
                <form action="{{URL('/draftsman/save_performa_invoice')}}" method="POST">
                    ...
                    <input type="hidden" value="{{$performa_invoice->id}}" name="performa_invoice_id" id="performa_invoice_id">
                    <input type="hidden" value="{{$performa_invoice->survey_charges_words}}" name="survey_charges_words" id="survey_charges_words">
                    <div class="row">
                        <div class="col-sm-6">
                            <label class="form-label-title mt-3" for="bill_invoice_no">Bill /Invoice No</label>
                            <input class="form-control" type="text" name="bill_invoice_no" id="bill_invoice_no" value="{{$performa_invoice->id}}" readonly>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="invoice_date" id="invoice_date" placeholder="Date" value="{{date('d-m-Y',strtotime($performa_invoice->invoice_date))}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="name_of_work" id="name_of_work" placeholder="Name of Work" value="{{$performa_invoice->name_of_work}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="work_orderno_date" id="work_orderno_date" placeholder="Work order No & Date" value="{{$performa_invoice->work_orderno_date}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="service_code" id="service_code" placeholder="Service Code (SAC)" value="{{$performa_invoice->service_code}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="service_description" id="service_description" placeholder="Description of Service" value="{{$performa_invoice->service_description}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="organization_name" id="organization_name" placeholder="Name of Organisation" value="{{$performa_invoice->organization_name}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="payment_mode" id="payment_mode" placeholder="Mode of Payment" value="{{$performa_invoice->payment_mode}}">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="receiver_name" id="receiver_name" placeholder="Name" value="{{$performa_invoice->receiver_name}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="receiver_address" id="receiver_address" placeholder="Address" value="{{$performa_invoice->receiver_address}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="state_code" id="state_code" placeholder="State Code" value="{{$performa_invoice->state_code}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="gstin_unique_id" id="gstin_unique_id" placeholder="GSTIN/Unique ID" value="{{$performa_invoice->gstin_unique_id}}">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="number" name="survey_charges" id="survey_charges" placeholder="Taxable Bill value" oninput="calculateTaxAmount()" value="{{$performa_invoice->survey_charges}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input class="form-control bg-white" type="text" name="cgst_amount" id="cgst_amount" value="{{$performa_invoice->cgst_amount}}" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input class="form-control bg-white" type="text" name="sgst_amount" id="sgst_amount" value="{{$performa_invoice->sgst_amount}}" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control bg-white" type="text" name="total_tax_amount" id="total_tax_amount" value="{{$performa_invoice->total_tax_amount}}" readonly>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control bg-white" type="text" name="total_tax_amount_words" id="total_tax_amount_words" value="{{$performa_invoice->total_tax_amount_words}}" readonly>
                            <div id="survey_charges_error"></div>
                            @error('survey_charges')
                                <p style="color: red">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control bg-white" type="text" name="total_invoice_amount" id="total_invoice_amount" value="{{$performa_invoice->total_invoice_amount}}" readonly>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control bg-white" type="text" name="total_invoice_amount_words" id="total_invoice_amount_words" value="{{$performa_invoice->total_invoice_amount_words}}" readonly>
                            <div id="survey_charges_error"></div>
                            @error('survey_charges')
                                <p style="color: red">{{ $message }}</p>
                            @enderror
