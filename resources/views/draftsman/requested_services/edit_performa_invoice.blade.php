                ...
                <form action="{{URL('/draftsman/save_performa_invoice')}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="text" name="survey_charges" id="survey_charges" placeholder="Taxable Bill value" oninput="calculateTaxAmount()" value="{{$performa_invoice->survey_charges}}">
