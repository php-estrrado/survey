...
<div class="page-header">
	<div class="page-leftheader">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page"><a href="{{url('/superadmin/customers/create')}}">Add Customers</a></li>
		</ol>
	</div>
</div>
<!--End Page header-->
...
<div class="row">
	<div class="col-12">
		<form method="POST" id="customerLogin" action="{{ url('/superadmin/customers/customerSave') }}" class="theme-form">
			@csrf
			...
			<div class="card">
				<div class="card-body">
					<div class="row">
						...
						<div class="col-sm-6 col-md-6">
							<div class="form-group">
								<label class="form-label" for="full_name">Authentication Authority <span class="text-red">*</span></label>
								<input type="text" class="form-control" placeholder="Auto Populate">
							</div>
						</div>
			...
			<div class="btn-list d-flex justify-content-end">
				...
				<a href="{{url('/superadmin/customers')}}" class="btn btn-danger">Cancel</a>
			</div>
		</form>
	</div>
</div>
