					...
					<div class="row">
						<div class="col-sm-6 col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="usr_role_name" placeholder="First name">
							</div>
						</div>
					</div>
				</div>
										...
										<td>
											<div class="form-group mb-0">
												<label class="custom-switch" for="view-{{$pt['id']}}">
													<input class="custom-switch-input" name="modules[{{$pt['id']}}]['view']" data-selid="{{$pt['id']}}" id="view-{{$pt['id']}}" value="1"  type="checkbox" />
										...
										<td>
											<div class="form-group mb-0">
												<label class="custom-switch" for="edit-{{$pt['id']}}">
													<input class="custom-switch-input" name="modules[{{$pt['id']}}]['edit']" id="edit-{{$pt['id']}}" data-selid="{{$pt['id']}}" value="1"  type="checkbox"  />
													<span class="custom-switch-indicator"></span>
												</label>
											</div>
										</td>
										<td>
											<div class="form-group mb-0">
												<label class="custom-switch" for="delete-{{$pt['id']}}">
													<input class="custom-switch-input" name="modules[{{$pt['id']}}]['delete']" id="delete-{{$pt['id']}}" data-selid="{{$pt['id']}}" value="1"  type="checkbox"  />
													<span class="custom-switch-indicator"></span>
												</label>
											</div>
										</td>
												...
												<td>
													<div class="form-group mb-0">
														<label class="custom-switch" for="ch-view-{{$ch['id']}}">
															<input class="custom-switch-input" name="modules[{{$ch['id']}}]['view']" id="ch-view-{{$ch['id']}}" data-selid="{{$ch['id']}}" value="1"  type="checkbox"  />
															<span class="custom-switch-indicator"></span>
														</label>
													</div>
												</td>
												<td>
													<div class="form-group mb-0">
														<label class="custom-switch" for="ch-edit-{{$ch['id']}}">
															<input class="custom-switch-input" name="modules[{{$ch['id']}}]['edit']" data-selid="{{$ch['id']}}" id="ch-edit-{{$ch['id']}}" value="1"  type="checkbox"  />
															<span class="custom-switch-indicator"></span>
														</label>
													</div>
												</td>
												<td>
													<div class="form-group mb-0">
														<label class="custom-switch" for="ch-delete-{{$ch['id']}}">
															<input class="custom-switch-input" name="modules[{{$ch['id']}}]['delete']" id="ch-delete-{{$ch['id']}}" data-selid="{{$ch['id']}}" value="1"  type="checkbox" />
															<span class="custom-switch-indicator"></span>
														</label>
													</div>
												</td>
