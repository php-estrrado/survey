    ...
    public function saveSurvey(Request $request)
    {
        ...
        if($input['id'] > 0)
        {
            $validator = Validator::make($request->all(), [
                ...
                'survey_area' => ['nullable','regex:/^[a-zA-Z\s]*$/'],
                ...
                'lattitude2' => ['nullable','regex:/^[a-zA-Z0-9\s.,]*$/'],
                'longitude2' => ['nullable','regex:/^[a-zA-Z0-9\s.,]*$/'],
                'x_coordinates2' => ['nullable','regex:/^[a-zA-Z0-9\s.,]*$/'],
                'y_coordinates2' => ['nullable','regex:/^[a-zA-Z0-9\s.,]*$/'],
                'detailed_description_area' => ['required','regex:/^[a-zA-Z0-9\s.,]*$/'],
                'no_of_surveys' => ['required','regex:/^[0-9]*$/'], 
                ...
                'width' => ['required','regex:/^[0-9]*$/'],
                'depth' => ['required','regex:/^[0-9]*$/'],
                'level_upto' => ['required','regex:/^[0-9]*$/'],
            ]);
