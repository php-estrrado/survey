    ...
    public function saveSurvey(Request $request)
    {
        ...
        if($input['id'] > 0)
        {
            $validator = Validator::make($request->all(), [
                ...
                'tidal_area' => ['required','regex:/^[a-zA-Z\s]*$/'],
                ...
                'duration' => ['nullable','regex:/^[a-zA-Z0-9\s.,]*$/'],
                'duration_weeks' => ['nullable','regex:/^[a-zA-Z0-9\s.,]*$/'],
                'duration_days' => ['nullable','regex:/^[a-zA-Z0-9\s.,]*$/'],
                'duration_hours' => ['nullable','regex:/^[a-zA-Z0-9\s.,]*$/'],
                'description_of_benchmark' => ['nullable','regex:/^[a-zA-Z0-9\s.,]*$/'],
