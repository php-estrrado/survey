...
class RequestedServicesController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['requested_services']  =  DB::table('survey_requests')
                                        ...
                                        ->where('survey_requests.cust_id',$cust_id)->where('survey_requests.is_active',1)->where('survey_requests.is_deleted',0)->where('survey_requests.cartographer_request','=',0)
    ...
    public function request_service_detail($id,$status)
    {
        ...
        $data['survey_datas'] = DB::table('survey_request_logs')
                                ...
                                ->leftjoin('usr_management', 'usr_management.admin_id', '=', 'survey_request_logs.created_by')
                                ...
                                ->select('survey_request_logs.created_at AS log_date','survey_request_logs.*','survey_status.*','survey_requests.*','usr_management.designation','usr_management.fullname','usr_management.role')
    ...
    public function survey_file_download($id)
    {
