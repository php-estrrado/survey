...
class ServicerequestsController extends Controller
{
    ...
    public function requested_service_detail($id,$status)
    {
        ...
        $data['survey_datas'] = DB::table('survey_request_logs')
                                ...
                                ->select('survey_request_logs.created_at AS log_date','survey_request_logs.*','survey_status.*','usr_management.designation','usr_management.fullname','usr_management.role')
