...
class Homepage extends Controller
{
    ...
    {  
        ...
        $dashboard_data['field']['accepted_assignments'] = Survey_requests::where('assigned_surveyor',$user_id)->whereIn('request_status',[42,62,63])->count();
        $dashboard_data['field']['accepted_reassignments'] = Survey_requests::where('assigned_surveyor',$user_id)->whereIn('request_status',[60,30,32,33])->count();
        ...
        $dashboard_data['survey']['accepted_assignments'] = Survey_requests::where('assigned_surveyor_survey',$user_id)->whereIn('request_status',[40,65,66])->count();
        $dashboard_data['survey']['accepted_reassignments'] = Survey_requests::where('assigned_surveyor_survey',$user_id)->whereIn('request_status',[59,20,36,37])->count();
    ...
    {  
        ...
        {   
            ...
            foreach ($accepted_assignments as $ak => $av) {
                ...
                $remarks_log = Survey_request_logs::where('survey_request_id',$av->id)->where('survey_status',$av->request_status)->orderBy('created_at', 'desc')->first();
